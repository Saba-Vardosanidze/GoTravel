...
const Header = () => {
  ...
  return (
    <header className="flex justify-between items-center m-auto mt-[16px] lg:mt-[32px] pr-[16px] lg:pr-[86px] pl-[16px] lg:pl-[86px] max-w-[361px] lg:max-w-[1728px] min-h-[35px]">
      <Link to="/">
        <img
      ...
      <div className="flex lg:justify-center lg:items-center lg:gap-[20px]">
